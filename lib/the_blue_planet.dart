...
class EarthPlanet extends StatefulWidget {
  const EarthPlanet({super.key});

  @override
  State<EarthPlanet> createState() => _EarthPlanetState();
}
                  ...
                  children: [
                    ...
                    const CircleAvatar(
                      ...
                      backgroundImage: AssetImage(
                          "assets/Rotating_earth_animated_transparent.gif"),
                    ),
                    SizedBox(
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => MarsPlanet(),));
                    },
                    child: const CircleAvatar(
                      radius: 35,
                      backgroundColor:  Color(0xff101010),
                      backgroundImage:
                          AssetImage("assets/mars-removebg-preview.png"),
                    ),
                  ),
                  SizedBox(
                    height: size.height / 38,
